...
#include "DigitDetector_interface.h"
cv::Mat dummyMap;
extern cv::Mat biMap, not_biMap;
...
{
	VideoCapture cap;
	cap.open("/home/auto710/148.avi");
	DigitDetector detector;
	TwoLayerNNFaster nn_print(TEST);
	TwoLayerNNFaster nn_led(TEST);
	// nn_print.loadParams("/homenn_params_hist_iter_12000_180.txt");
	nn_led.loadParams("/home/auto710/Lancelot/config/nn_params_hist_iter_12000_180_no_box.txt");
